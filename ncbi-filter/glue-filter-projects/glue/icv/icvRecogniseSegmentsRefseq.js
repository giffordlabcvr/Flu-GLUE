...
var allResults = [];
var whereClause = "source.name like 'icv-ncbi-refseqs-seg%'";

glue.inMode("module/icvSegmentRecogniser", function(){

	 var recogniserResult = glue.command(["recognise","sequence","-w", whereClause]);
