// list the sequences in source ncbi-idv-nuccore
var listSeqResult = glue.command(["list", "sequence", "-w", "source.name = 'ncbi-idv-nuccore'"]);
...
_.each(seqIds, function(seqId) {
    ...
    glue.inMode("sequence/ncbi-idv-nuccore/"+seqId, function() {
