// list the sequences in source ncbi-ibv-nuccore
var listSeqResult = glue.command(["list", "sequence", "-w", "source.name = 'ncbi-ibv-nuccore'"]);
...
_.each(seqIds, function(seqId) {
    ...
    glue.inMode("sequence/ncbi-ibv-nuccore/"+seqId, function() {
