...
glue.inMode("module/tabularUtility", function() {
	strainObjs = glue.tableToObjects(glue.command(["load-tabular", "tabular/genus/icv/icv-strains.complete.out.tsv"]));
});
...
_.each(strainObjs, function(strainObj) {
	...
	_.each(segments, function(segment) {
		...
		var sourceName = 'icv-ncbi-curated-segment-' + segment;
