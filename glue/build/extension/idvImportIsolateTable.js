...
glue.inMode("module/tabularUtility", function() {
    isolateObjs = glue.tableToObjects(glue.command(["load-tabular", "tabular/extension/idv_nuccore_isolates.tsv"]));
});
...
_.each(isolateObjs, function(isolateObj) {
    ...
    glue.inMode(isolatePath, function() {
        ...
        glue.command(["set", "field", "is_complete", (foundSegments === 7 ? "TRUE" : "FALSE")]);
